...
- Bypass language release check for logged-in users on Panel/API routes

## [1.2.0] - 2026-04-16

### Added

- Add translation status indicators and update language files
...
[1.2.1]: https://github.com/nerdcel/kirby-languagerelease/compare/v1.2.0...v1.2.1
[1.2.0]: https://github.com/nerdcel/kirby-languagerelease/compare/v1.1.0...v1.2.0
